    ...
    <header class="header">
        ...
        <div class="navbar">
          <div class="navbar-left-container">
            <a href="/">
              <img class="navbar-brand-logo" src="static/shop.png">
                  ...
                  <div class="nav-user-list">
                    <div class="full" v-show="haveLen">
                      ...
                      <div class="nav-cart-items">
                        <ul>
                          <li class="clearfix" v-for="(item,index) in cartList" v-on:mouseover="delShowIndex=index" :key="index">
                            <div class="cart-item">
  ...
  methods: {
    ...
    getCartData() {
      axios.get('/api/users/getCartData').then((res) => {
        res = res.data;
        console.log(res, "users/getCartData")
        if(res.status==='1'){
