        ...
        <div class="container" ref="accHock">
          <div class="filter-nav">
            ...
            <a
              ...
              <i
                :class="
                  sortFlag === true ? 'icon-arrow-up2' : 'icon-arrow-down2'
                "
              ></i
            ></a>
            <a
            ...
            >
              <dl class="filter-price">
                ...
                <dd>
                  <a
                    href="javascript:void(0)"
                    :class="{ cur: clickflag === 'all' }"
                    @click.stop="setClickAll"
                    >All</a
                  >
                </dd>
            ...
            <div class="accessory-list-wrap">
              ...
              <div
                ...
                style="
                  width: 100%;
                  height: 100%;
                  background: url(../../static/404.png) no-repeat center;
                "
              >
...
export default {
  data() {
    return {
      ...
      slides: [
        {
          src: require("../../static/slide-img/1609920121315.jpg"),
          title: "",
          href: "detail/count",
        },
        {
        ...
        {
          src: require("../../static/slide-img/1610008718030.jpg"),
          title: "",
          href: "http://xxx.xxx.com",
        },
        {
          src: require("../../static/slide-img/1609925736401.jpg"),
          title: "",
...
.guide-content {
  width: 100%;
  display: flex;
  background: url('../../static/slide-img/1608880463949.jpg') no-repeat center top;
  padding-bottom: 30px;
