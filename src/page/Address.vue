        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li v-for="(item, index) in limitAdressNum" :class="{'check':item.isDefault===1}" :key="index">
                    <dl>
                      <dt>{{item.postName}}</dt>
  ...
  export default{
      ...
      methods:{
        ...
        insertAdr(item) {
          ...
          console.log(this.newAddressList.postName);
          var param = {
            postName:this.newAddressList.postName,
